...
model {
  ...
  psi1_species ~ normal(0, sigma_psi1_species); // species-specific intercepts (centered on global)
  sigma_psi1_species ~ normal(0, 0.5); // variation in species-specific intercepts
